                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('credits') is-invalid @enderror" 
                               id="credits" name="credits" min="1" max="12" value="{{ old('credits', $course->credits) }}" required>
                        @error('credits')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('faculty_id') is-invalid @enderror" 
                        ...
                        @foreach($faculty as $member)
                            <option value="{{ $member->id }}" {{ old('faculty_id', $course->faculty_id) == $member->id ? 'selected' : '' }}>
